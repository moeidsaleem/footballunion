...
@IonicPage()
@Component({
  selector: 'page-fsignup',
  templateUrl: 'fsignup.html',
})
export class FsignupPage{
  ...
  constructor(public navCtrl: NavController,private helper:HelpersProvider,private fb:Facebook,private spinner:SpinnerProvider,
